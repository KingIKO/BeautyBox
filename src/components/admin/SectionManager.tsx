    ...
    <div className="space-y-4">
          ...
          return (
            ...
            >
              ...
              >
                {Icon && (
                  <span
                    className={`flex h-9 w-9 items-center justify-center rounded-xl ${eventConfig?.color ?? "bg-muted text-muted-foreground"}`}
                  >
      ...
      {availableEventTypes.length > 0 && (
        <div className="relative">
          ...
          {addingSectionType && (
            <div className="absolute left-0 right-0 mt-2 bg-card border border-border/60 rounded-2xl shadow-soft z-10 overflow-hidden py-1.5">
              {availableEventTypes.map((et) => {
                ...
                return (
                  <button
                    ...
                    className="w-full flex items-center gap-3 px-5 py-3 hover:bg-secondary/60 transition-colors text-left text-sm"
                  >
                    {Icon && (
                      <span
                        className={`flex h-8 w-8 items-center justify-center rounded-xl ${et.color}`}
                      >
